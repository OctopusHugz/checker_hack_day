...
def pid_from_cwd():
    ...
    web_front_end_list = [{582: "0x00-html_advanced"},
                          {590: "0x01-developer_tools"}, {583: "0x02-CSS_advanced"}, {363: "0x03-sass_scss"}, {598: "0x04-flexbox"}, {599: "0x05-form"}, {601: "0x07-accessibility"}]
    web_back_end_list = [{574: "0x00-python_variable_annotations"}, {575: "0x01-python_async_function"}, {576: "0x02-python_async_comprehension"},
                         {390: "0x03-caching"}, {585: "0x04-pagination"}, {602: "0x05-personal_data"}, {380: "0x06-Basic_authentication"}, {383: "0x07-Session_authentication"}, {584: "0x08-user_authentication_service"}]
    interview_list = [{498: "0x00-lockboxes"}, {439: "0x01-insert_in_sorted_linked_list"}, {465: "0x02-heap_insert"}, {488: "0x03-minimum_operations"}, {460: "0x04-sandpiles"}, {440: "0x05-linked_list_palindrome"}, {474: "0x06-log_parsing"}, {438: "0x07-linked_list_cycle"},
                      {444: "0x08-palindrome_integer"}, {490: "0x09-utf8_validation"}, {451: "0x0A-slide_line"}, {454: "0x0B-menger"}, {463: "0x0C-nqueens"}, {455: "0x0D-sorted_array_to_avl"}, {461: "0x0E-linear_skip"}, {470: "0x0F-starwars_api"}]
    projects = {"sedo": sedo_list, "low": low_list, "high": high_list,
                "web_front_end": web_front_end_list, "web_back_end": web_back_end_list, "interview": interview_list}
